...
public class BookingRequestAdapter extends ArrayAdapter<String> {
    ...
    public BookingRequestAdapter(Activity context, ArrayList<String> id, ArrayList<String> day, ArrayList<String> hour, ArrayList<Bitmap> time) {
        super(context, R.layout.lsttemplatecollectionschedule, id);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rootView = inflater.inflate(R.layout.lsttemplatecollectionschedule, null, true);
