...
public class OngoingProjectTaskFragListAdapter extends ArrayAdapter<String> {
    ...
    public OngoingProjectTaskFragListAdapter(Activity context, ArrayList<String> taskvalue, ArrayList<String> description, ArrayList<String> status) {
        super(context, R.layout.lsttemplateongoingprojecttasklist, taskvalue);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rootView = inflater.inflate(R.layout.lsttemplateongoingprojecttasklist, null, true);
        ...
        try {
            ...
            lblstatus.setText(itemstatus.get(position).toString());
