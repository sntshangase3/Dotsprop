    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fb.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                intent.setData(Uri.parse("https://www.facebook.com/discoverysouthafrica/"));
        ...
        twt.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("https://twitter.com/Discovery_SA"));
                startActivity(intent);
            }
        });
        instagram.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("http://instagram.com/discovery_sa"));
                startActivity(intent);
            }
        });
        ...
        web.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                intent.setAction(Intent.ACTION_VIEW);
                intent.addCategory(Intent.CATEGORY_BROWSABLE);
                intent.setData(Uri.parse("https://www.discovery.co.za"));
                startActivity(intent);
            }
        });
...
private String z="";
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
             ...
             String[] to = {"sntshangase3@gmail.com","KyleDe@discovery.co.za","ElsabeR@discovery.co.za","JosannH@discovery.co.za"};

                String from =txtFrom.getText().toString();
                String subject = txtSubject.getText().toString();
                String message = txtMessage.getText().toString()+"\n\n------\nRegards - PokeMon App(By Sibusiso)\n\nThis email was intended for & sent to you by Discovery App\nHead Office – Century City, Cape Town – South Africa";
